...
namespace CW_3_v2.Services
{
    public class SqlServerDbService : IStudentsDbService
    {
        ...
        {
            var returnedEnroll = new Models.Enrollment();
            using (var client = new SqlConnection(connectionString))
            using (var com = new SqlCommand())
            {
                com.Connection = client;
        ...
        public bool ConatinsEnrollment(PromotePost promotePost)
        {
            ...
            using (var com = new SqlCommand())
            {
                ...
                com.Parameters.AddWithValue("postedStudiesName", promotePost.Studies);
                com.Parameters.AddWithValue("semesterNo", promotePost.Semester);
        ...
        public Models.Enrollment PromotedEnrollmentStudent(PromotePost promotePost)
        {
            var returnedEnroll = new Models.Enrollment();
                ...
                using (var com2 = new SqlCommand())
                {
                    ...
                    com2.Parameters.AddWithValue("courseName", promotePost.Studies);
        ...
        public bool ExecuteDatabaseProcedurePromote(PromotePost promotePost)
        {
            ...
            using (var com = new SqlCommand())
            {
                ...
                com.Parameters.AddWithValue("studies", promotePost.Studies);
                com.Parameters.AddWithValue("semester", promotePost.Semester);
                try
                {
